...
function get_products_with_pagination($perPage='6'){
    ...
    if($page == 1){
        ...
        $middleNumber.='<li class="page-item active"><a>'.$page.'</a></li>';

        $middleNumber.='<li class="page-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?page='.$add1.'">'.$add1.'</a></li>';


    } elseif($page == $lastPage){

        $middleNumber .= '<li class="page-item"><a class="page-link" href="' . $_SERVER['PHP_SELF'] . '?page=' . $sub1 . '">' . $sub1 . '</a></li>';
    ...
    $middleNumber.='<li class="page-item active"><a>'.$page.'</a></li>';
        ...
        $middleNumber.='<li class="page-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?page='.$sub2.'">'.$sub2.'</a></li>';
        ...
        $middleNumber.='<li class="page-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?page='.$add2.'">'.$add2.'</a></li>';
